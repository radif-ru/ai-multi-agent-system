...
|:--:|----------|------|-------|:------:|:------:|:------:|
| 09 | MAX-адаптер | [`sprints/09-max-adapter.md`](./sprints/09-max-adapter.md) | `feature/09-max-adapter` | Active | 2026-06-04 | — |
...
| 09. MAX-адаптер | Active | 11 / 0 / 0 | `sprints/09-max-adapter.md` |
