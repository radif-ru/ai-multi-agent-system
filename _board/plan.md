...
> Пока активного спринта нет, мелкие правки идут через [`maintenance.md`](./maintenance.md) (см. [`process.md`](./process.md) §12).
...
| 15. Расширения почты, диска и планировщика | Closed | 0 / 0 / 16 | `sprints/15-mail-disk-scheduler-ext.md` |
