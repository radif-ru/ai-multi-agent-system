...
|:--:|----------|------|-------|:------:|:------:|:------:|
| 13 | Интеграции почты и диска, скиллы со скриптами | [`sprints/13-mail-disk-skills.md`](./sprints/13-mail-disk-skills.md) | `feature/13-mail-disk-skills` | Active | 2026-07-08 | — |
...
| 13. Интеграции почты и диска, скиллы со скриптами | Active | 14 / 0 / 4 | `sprints/13-mail-disk-skills.md` |
