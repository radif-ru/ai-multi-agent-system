...
**Инструменты и файлы** — погода, веб-поиск, чтение PDF, обработка фото (vision), голосовые сообщения, безопасность (изоляция пользователей):

![Telegram — инструменты и файлы](docs/screenshots/Telegram-1.png)

**Планировщик и почта** — создание cron-задачи на естественном языке, отчёт по почте, управление задачами, черновик письма, disk_upload:

![Telegram — планировщик и почта](docs/screenshots/Telegram-2.png)
