...
> **Task-префиксы.** `nomic-embed-text` рекомендует префиксы `search_document:` (при индексации) и `search_query:` (при поиске). Внедрение — задача 3.2 спринта 14 (см. [ADR-4](./decisions.md#adr-4-качество-rag-task-префиксы-метрика-чанкинг)). Без префиксов качество семантического поиска понижено.
