...
│   ├── process.md            # свод правил и процесса: легенды, шаблоны, §0–§12
│   ├── maintenance.md        # журнал внеспринтовой работы (process.md §12)
│   └── sprints/              # файлы спринтов: <NN>-<short-name>.md
│       ├── 00-bootstrap.md
│       └── 01-mvp-agent.md
│
├── .agents/                  # промпты и скиллы для AI-ассистента разработки (не runtime бота)
│   ├── README.md             # индекс: список промптов и скиллов, форматы
│   ├── prompts/              # переиспользуемые промпты (*.prompt.md), запускаются по требованию
│   └── skills/               # дисциплины ассистента (<name>/SKILL.md), подхватываются автоматически
│
...
| `_board/process.md` | Свод правил процесса: легенды, правила спринтов и задач, шаблоны, пошаговый алгоритм (§0–§12). |
| `_board/maintenance.md` | Журнал внеспринтовой работы: хотфиксы и правки по итогам аудита, сделанные вне активного спринта (`process.md` §12). |
