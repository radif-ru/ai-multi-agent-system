...
│   ├── maintenance.md        # журнал внеспринтовой работы (process.md §13)
...
| `_board/maintenance.md` | Журнал внеспринтовой работы: хотфиксы и правки по итогам аудита, сделанные вне активного спринта (`process.md` §13). |
