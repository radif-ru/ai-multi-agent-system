...
- **Только относительные пути.** В любой документации (`_docs/`, `_board/`, `README.md`, `.env.example`, `_skills/`, `_prompts/`, `AGENTS.md`) запрещены абсолютные пути файловой системы (`/home/...`, `/Users/...`, `C:\...`). Все ссылки — относительно корня проекта (`_docs/...`, `_board/...`, `app/...`, `./architecture.md`).
