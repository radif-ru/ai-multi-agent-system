...
## 5. Автоматизируй без ИИ

**Детерминированное и повторяемое — автоматизируй инструментом, а не ИИ и не глазами.**

- Рутинную проверку или операцию, выразимую кодом (линт, синхронизация конфига/доски, валидность ссылок, прогон тестов), оформляй скриптом или CI-гейтом — он дешевле, быстрее и надёжнее ИИ.
- Повтор — сигнал к инструменту: делаешь одну и ту же сверку руками или просишь ИИ дважды → напиши скрипт (`scripts/`, гейт в CI).
...
- **Работа вне спринта** (хотфикс, правка по итогам аудита, когда активного спринта нет) — `_board/process.md` §13 и журнал `_board/maintenance.md`. «Безымянных» коммитов в обход доски быть не должно.
